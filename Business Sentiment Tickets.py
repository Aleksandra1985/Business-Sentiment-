...
# STAGE 2. Tickets Corpus (2.1.) Reading, Special Preprocessing
#         (2.2.) Special Symbols and UpperCase counting and
#         (2.3.) English language filtering
# STAGE 3. Find words in the Ticket Descriptions that match the BS lexicon
...
#____________________Contextual Tickets texts based__________________________________
   
   path='C:/Users/Sentiment/Ticket_Sentiment_pos'
...
# _____STAGE 2.1. Tickets Corpus Reading, Special Preprocessing_____________________
...
# _____________________STAGE 2.3. Tickets Corpus English language filtering_____________________________                  
...
# ____STAGE 3.1. Find words in the Ticket description that match the BS lexicon Expressions_______________
...
# ____STAGE 3.1. Find words in the Tickes that match the BS lexicon Keywords__________________
# _____________  Count number of matched words and their total Score_________________________
